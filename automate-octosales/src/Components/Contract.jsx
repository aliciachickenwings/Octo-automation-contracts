...
const CreateContactForm = (props) => {
  ...
  return (
    <div className="contract-form-wrapper">
      <button onClick={handleContract}>Generate PDF</button>
      <div className="contract-content-container" ref={contract}>
        <div>
        ...
        <div className="contract-content-part" id="part-2">
          ...
          <strong>
            ...
            <p>
              Deze opzeggingstermijn vangt aan op de maandag volgend op de datum
              van verzending van het aangetekend schrijven of wederzijdse
              bevestiging via mailverkeer met het e-mailadres:
              <a href="mailto:career@octosales.be">career@octosales.be</a>
            </p>
          </strong>
          <p>
            2.2 De overeenkomst wordt automatisch beëindigd indien de uitvoering
          ...
          <p>
            ...
            artikel 2.1 kunnen beide partijen deze overeenkomst beëindigen door
            middel van een opzeggingstermijn van één week betekend per
            ...
            meer door de partijen te worden nageleefd, onverminderd wat verderop
            of in de deelovereenkomst wordt bepaald.
          </p>
          <p>
            2.4 Indien de opzegging eenzijdig door de opdrachtgever plaatsvindt
            zonder inachtname van deze periode, wordt overeenkomstig artikel
            1794 van het Burgerlijk Wetboek, een forfaitaire schadevergoeding
            aangerekend van 500 EUR voor al de uitgaven van de Dienstverlener,
            al zijn arbeid, en alles wat hij bij die opdracht had kunnen winnen.
            De overeenkomst wordt geschorst vanaf het ogenblik dat de
          ...
          <p>
            ...
            <ul>
              <li>
                ...
                toegekend budget na meerdere ingebrekestellingen van de
              ...
              <li>
                het ontvreemden van materialen van de opdrachtgever en dit in de
                meest ruime zin van het woord; -misbruik van vertrouwen door één
                partij (of beide partijen) wat een onmiddellijke beëindiging tot
                gevolg heeft;
              </li>
          ...
          <p>
            ...
            binnen 5 kalenderdagen na voorlegging van de prestatiestaat door de
            Dienstverlener.
          </p>
        </div>
        <div className="contract-content-part" id="part-3">
          ...
          <p>
            De diensten worden geleverd aan de opdrachtgever of één of meerdere
            van haar klanten, in de gebouwen van de opdrachtgever of bij één of
            meerdere van haar klanten, tenzij anders overeengekomen.
          </p>
        </div>
        <div className="contract-content-part" id="part-4">
          ...
          <div>
            ...
            <div>
              ...
              voor het leveren van de diensten een beroep te doen op uitvoerders
              die over de nodige competenties en vakkennis beschikken om de
              overeengekomen opdrachten uit te voeren binnen de overeengekomen
              termijn. De uitvoerders van de Dienstverlener moeten de
            ...
            <div>
              ...
              worden gegarandeerd wanneer de opdrachtgever niet alle knowhow en
              andere benodigde informatie meedeelt of bezorgt, ook
              confidentiële, die de Dienstverlener nodig heeft voor de
              vervulling van zijn opdrachten.
              <br />
              De Dienstverlener bezorgt de overeenkomstige facturen inzake zijn
              prestaties uiterlijk 1 kalenderweek na de desbetreffende
            ...
            <div>
              ...
              zijn uitvoerders. Vertrouwelijke informatie betreft: bedrijfs- of
              eigendomsinformatie, informatie met betrekking tot producten,
              cliënteel, zakenrelaties, financiële of contractuele afspraken met
              betrekking tot de opdrachtgever en/of alle vennootschappen van de
              groep waarvan de opdrachtgever deel uitmaakt.
              <br />
              Bij de beëindiging van de onderhavige overeenkomst, om welke reden
          ...
          <div>
            ...
            <div>
              ...
              arbeidsreglementering ten opzichte van zijn werknemers waarop hij
              desgevallend een beroep doet voor een opdracht. Dit omvat maar is
              niet beperkt tot:
              <ul>
            ...
            <div>
              ...
              niet kan voortzetten, zal hij de opdrachtgever onmiddellijk op de
            ...
            <div>
              ...
              zich ertoe strikt de bepalingen van de wet van 27 juli 1987 na te
              leven.
              <br /> De opdrachtgever is bijgevolg gerechtigd om de uitvoerders
              richtlijnen mee te geven inzake de uitvoering van de opdrachten
              volgens de lijnen uiteengezet in deze overeenkomst:
              <br />
              *richtlijnen in verband met de uitvoering van het in onderhavige
              ...
              <p>
                ...
                uitoefenen ten aanzien van de uitvoerders. De dagelijkse leiding
          ...
          <div>
            ...
            <p>
              ...
              automatische beëindiging van de deelovereenkomsten) ten laste van
              de Dienstverlener met onmiddellijke ingang kan ontbinden, zonder
              voorafgaande verwittiging. De Dienstverlener is in dat geval
              gehouden de opdrachtgever te vergoeden voor de directe schade die
              de opdrachtgever heeft geleden.
            </p>
          </div>
        </div>
        <div className="contract-content-part" id="part-5">
          ...
          <p>
            ...
            Dienstverlener alle knowhow en andere benodigde informatie, evenals
            confidentiële informatie, mee te delen, noodzakelijk voor de
            vervulling van de opdrachten bepaald in de deelovereenkomsten.
          </p>
          <p>
          ...
          <p>
            ...
            te controleren. Hiermee doet hij geenszins afbreuk aan de autonomie
            waarin de Dienstverlener het werk verricht.
          </p>
        </div>
        <div className="contract-content-part" id="part-6">
          ...
          <p>
            ...
            noch rechtstreeks noch onrechtstreeks, en dit zowel tijdens de duur
            van de overeenkomst als tijdens een periode van 12 maanden nadat de
            prestaties beëindigd of opgeschort zijn of wanneer kandidaten zijn
            voorgesteld. Indien een inbreuk hierop wordt vastgesteld is er een
          ...
          <p>
            ...
            enkel verschuldigd als het bedrijf en de student, stagiair, bediende
            of freelancer een akkoord bereiken of binnen 12 maanden nadat de
          ...
          <p>
            ...
            <p>
              ...
              OctoSales dan kan de flat fee vermeld in artikel 6.2, afhankelijk
              van de situatie waar de kandidaat zich in bevindt, pro rata in
              vermindering gebracht worden in verhouding met de reeds
        ...
        <div className="contract-content-part" id="part-7">
          ...
          <p>
            ...
            gevolg zijn van een tekortkoming van de Dienstverlener onder meer de
            winstderving, de verhoging van de algemene kosten, het verstoren van
            de planning, het verlies van materieel, het verlies van de verhoopte
            winst van cliënteel of besparingen.
          </p>
          <p>
            De aansprakelijkheid van de Dienstverlener hoe ernstig de fout ook
            is, behalve in geval van bedrog, beperkt is tot schade waarvoor zij
            aansprakelijk is.
          </p>
          <p>
            De aansprakelijkheid van de Dienstverlener is strikt beperkt tot de
            hem toevertrouwde taken en kan nooit de waarde van de
            dienstverleningsovereenkomst overstijgen. De Dienstverlener is niet
            verantwoordelijk voor de gevolgen van vergissingen, fouten of
            vergetelheden van de opdrachtgever in de hem toevertrouwde opdracht,
            noch voor vergissingen, fouten of vergetelheden in de uitvoering
            bewerkstelligd door de opdrachtgever of door een derde.
          </p>
          <p>
            De Dienstverlener zal de werkzaamheden met betrekking tot deze
            opdracht uitvoeren naar beste kennis en vermogen, volgens de regels
            van de kunst en rekening houdend met de reglementen en voorschriften
            terzake. Indien de Dienstverlener fouten ontdekt in documenten door
            de opdrachtgever of door derden opgesteld, zal hij de opdrachtgever
            hiervan op de hoogte brengen. De Dienstverlener dient bij de
            uitvoering van het werk te handelen met de vereiste zorgvuldigheid
            die in het maatschappelijk verkeer betaamt, zowel ten aanzien van de
            persoon van de opdrachtgever en diens goederen als ten aanzien van
            derden.
          </p>
        </div>
        <div className="contract-content-part" id="part-8">
          <h3>Honorarium</h3>
          <p>
            Het honorarium bevat de knowhow, de proceskennis, de directe kosten
            (bedrijfslasten), de algemene kosten, de dekking van risico’s, de
            winst van de Dienstverlener en de kosten die de Dienstverlener
            draagt om te voldoen aan alle Belgische minimumvoorwaarden die de
          ...
          <p>
            ...
            beheerskosten, rekruterings- en selectiekosten en brutoloon student,
            exclusief sociale voordelen, BTW, maaltijdcheques, ecocheques,
            woon-werkverkeer en burgerlijke aansprakelijkheid. De Dienstverlener
            verbindt er zich toe om zoveel als mogelijk voorzienbare kosten
            voorafgaandelijk aan de opdrachtgever voor te leggen. Andere door de
            Dienstverlener gemaakte kosten zullen apart worden gefactureerd en
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                Maaltijdcheques: 1,69 op de werkgeversbijdragen en op het totale
                bedrag is er een dienstenprestatie van 3,5% verbonden
              </li>
          ...
          <p>
            ...
            akkoord van de opdrachtgever, vergoed op basis van gerechtvaardigde
            documenten. Deze onkosten worden gefactureerd aan kostprijs met een
            toeslag van 0%. De bewijsstukken dienen maandelijks gehecht te
            worden aan het document waarin deze onkosten worden samengevat en
            dienen alle aanwijzingen te vermelden die vervat zijn in de door de
            opdrachtgever gebruikte onkostennota's, meer in het bijzonder de
            aard van deze kosten, de data en de nummers van de werkzaamheden
            waarop ze geboekt moeten worden. Het hierboven vermelde document
            dient door de opdrachtgever voor akkoord ondertekend te worden.
          </p>
          <p>
            ...
            schommelingen van de consumptieindex. Deze aanpassing is gelijk aan
            het bedrag dat verkregen wordt door de toepassing van de
          ...
          <p>
            De elementen van deze formule worden als volgt omschreven: de basis
            vergoeding: het hiervoor vermelde honorarium; nieuwe index: het
            cijfer van de consumptieindex van de maand die aan de aanpassing van
            het honorarium voorafgaat of december van het voorgaande jaar voor
            de jaarlijkse indexering; aanvangsindex: het cijfer van de
            consumptieindex van de maand die voorafgaat aan de maand van
          ...
          <p>
            ...
            vermelde profielen, gelden voor één jaar vanaf ondertekening van de
        ...
        <div className="contract-content-part" id="part-9">
          ...
          <p>
            Indien er wijzigingen aangebracht worden aan de omschreven opdracht,
            die resulteren in meerwerk, zal dit meerwerk doorgerekend worden
            mits partijen een schriftelijk akkoord hierover hebben gesloten. In
            geval van meerwerk zal dit tegen de volgende toeslagfactoren worden
            gefactureerd :
          </p>
          <ul>
            <li>
          ...
          <p>
            Met betrekking tot zaterdag-, zondag- en feestdagenprestaties wordt
            er geen toeslagfactor aangerekend indien het om remote en flexibel
            werk draait waarbij de dienstverlener vrij zijn werkagenda mag
            indelen. De toeslagfactor is enkel van toepassing wanneer dit een
            verplichting is van de opdrachtgever om op die specifieke dag te
            werken.
          </p>
        </div>
        <div className="contract-content-part" id="part-10">
          ...
          <p>
            De door de Dienstverlener uitgevoerde werkzaamheden en gepresteerde
            uren zullen op prestatiestaten bijgehouden worden. Deze
            prestatiestaten dienen als basis voor de wekelijkse facturatie. De
            facturen zijn 8 dagen na factuurdatum betaalbaar.
          </p>
          <p>
          ...
          <p>
            Alle klachten betreffende de facturatie dienen binnen de 8 dagen na
            ontvangst van de factuur per aangetekend schrijven ingediend worden
            of via mailverkeer via het mailadres:
          ...
          <p>
            ...
            nalatigheidsinteresten verschuldigd zijn gelijk aan de rente bepaald
            in de Wet van 2 augustus 2002 (gewijzigd bij Wet van 22 november
            2013) betreffende de bestrijding van de betalingsachterstand bij
            handelstransacties. Eveneens is de opdrachtgever bij niet-betaling
            van het factuur op de vervaldag, van rechtswege en zonder
            voorafgaande ingebrekestelling, ten titel van schadebeding een
            forfaitaire schadevergoeding verschuldigd van 10% van het op de
            vervaldag onbetaalde factuurbedrag, met een minimum van 150 EUR en
            8,5% verwijlinteresten op jaarbasis vanaf de vervaldag, onverminderd
            het recht van de Dienstverlener een hogere schadevergoeding te
            vorderen mits bewijs van grotere werkelijk geleden schade. Bovendien
            behoudt de Dienstverlener zich het recht voor om bij niet-betaling
            van het factuurbedrag of in geval van laattijdige betaling een
            vergoeding te vorderen voor de gerechtelijke invorderingskosten, dit
            conform het recht op de gerechtskosten en het recht op de bijdrage
            in de erelonen en onkosten van advocaten.
          </p>
        </div>
        <div className="contract-content-part" id="part-11">
          ...
          <p>
            ...
            vervanging van een uitvoerder door een andere uitvoerder op voorhand
            mee te delen aan de opdrachtgever, rekening houdend met de
            bekommernissen van de opdrachtgever. Een uitvoerder dient steeds
            vervangen te worden door een uitvoerder met tenminste gelijkwaardige
            kwalificaties, ervaring en expertise. De uitvoerder/Dienstverlener
            staat in voor de opleiding en kennisoverdracht, indien nodig, en de
            kosten hiervan, bij een dergelijke vervanging. Dit zal enkel
            plaatsvinden bij goedkeuring van beide partijen.
          </p>
          <p>
        ...
        <div className="contract-content-part" id="part-12">
          ...
          <p>
            <strong>12.1</strong> Deze overeenkomst bevat het integraal akkoord
            tussen de partijen en vervangt en annuleert alle vroegere mondelinge
            of schriftelijke overeenkomsten, offertes, correspondentie of
            voorstellen met betrekking tot het voorwerp van deze overeenkomst.
          </p>
          <p>
            <strong>12.2</strong> Eventuele aanvullingen of wijzigingen aan deze
            overeenkomst zijn slechts geldig indien deze door de partijen
            schriftelijk overeengekomen worden.
          </p>
          <p>
            <strong>12.3</strong> Elke brief, aangetekende brief of notificatie
            zal geschieden op het adres van de partijen vermeld in het begin van
            onderhavige overeenkomst. Indien het adres wijzigt, zullen partijen
            elkaar onmiddellijk van deze adreswijziging op de hoogte brengen.
          </p>
          <p>
        ...
        <div className="contract-content-part" id="part-13">
          ...
          <p>
            ...
            regelgeving. Elk geschil omtrent de bepalingen van deze overeenkomst
            zal beslecht worden voor de bevoegde Belgische rechtbanken waar de
